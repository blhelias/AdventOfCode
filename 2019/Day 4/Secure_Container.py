...
def has_two_adjacents_digits(password: str) -> bool:
    if len(set(password)) != len(password):
        return True
    return False


def has_two_adjacents_digits_not_part_of_larger_group(password: str) -> bool:
...
def is_valid(password: str) -> bool:
    ...
    # elif not has_two_adjacents_digits_not_part_of_larger_group(password):
    elif not has_two_adjacents_digits(password):
        return False
